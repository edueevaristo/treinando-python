...
def jogar():
    ...
    nivel_dificuldade = int(input(
        "Qual será o nível de dificuldade? \n(1)Fácil (2)Médio (3)Difícil\nDigite aqui: "))
    ...
    while rodada <= total_de_tentativas:
        ...
        if acertou:
            ...
            if maior:
                print(
                    "Você errou! O seu chute foi maior que o número secreto. Tente um número mais baixo")
            elif menor:
                print(
                    "Você errou! O seu chute foi menor que o número secreto. Tente um número maior.")
